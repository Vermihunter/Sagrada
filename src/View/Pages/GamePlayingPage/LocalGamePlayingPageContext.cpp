...
LocalGamePlayingPageContext::LocalGamePlayingPageContext(
    LocalGamePlayingPage& parent, LocalPlayerController& controller, const ViewContext& viewCtx,
    std::unique_ptr<CommonGameElements> _commonGameElements)
    : GamePlayingPageContext(viewCtx, controller, std::move(_commonGameElements)),
