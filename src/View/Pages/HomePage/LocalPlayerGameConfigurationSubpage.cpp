...
LocalPlayerGameConfigurationSubpage::LocalPlayerGameConfigurationSubpage(
...
void LocalPlayerGameConfigurationSubpage::start_button_clicked()
{
    ...
    rnd_t rnd =
        (pageElements.lne_Seed.widget.get_text().empty())
    ...
    wpcChoosingPage = std::make_unique<WPCChoosingPage>(
        ctx, std::move(game), commonGameInfo->players, localPlayerCount);
