...
int main(int argc, char** argv)
{
    ...
    SagradaGameCMDLineParser simulationSubParser(
        logFileStream, false, &program, "simulation", "1.0",
        argparse::default_arguments::help);
    ...
    auto window = std::make_unique<SagradaWindow>(
        v_constants::window::size, gameMode, std::move(tournamentConfig));
