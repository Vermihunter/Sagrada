...
\addbibresource{sagrada_profiling.bib} % BibLaTeX bibliography file
...
\title{Performance evaluation of \\the board game Sagrada} % Article title, use manual lines breaks (\\) to beautify the layout
