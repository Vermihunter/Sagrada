...
constexpr SizeInPixels size{.width  = 600,
                            .height = SizeInPixels::pixel_size_t(600 / (2.14486638537))};
} // namespace sagradaLogo

/** Application window config*/
namespace window {
constexpr SizeInPixels size{.width = 1280,
...
constexpr SizeInPixels size{.width = 440, .height = SizeInPixels::pixel_size_t(440 / 1.1)};
}
