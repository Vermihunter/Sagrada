...
class RelocateDieIgnoreAttributeTCView : public RelocatingToolCardView {
  ...
  public:
	RelocateDieIgnoreAttributeTCView(ToolCardViewContainer& _parentContainer, Game& _game,
	                                              ...
	                                              const BoardIndex&     boardInd) override
	{
		...
		auto move = new RelocateDieMove(playerOnMoveID, ind, *fromField, boardInd, mask_attr);
  ...
  private:
	...
	{
		move_c usableMoves = try_make_ind_from_field(tc, boardView, boardInd, nullptr);
