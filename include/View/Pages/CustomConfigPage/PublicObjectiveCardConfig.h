...
class PublicObjectiveCardConfig : public Gtk::VBox {
  public:
	PublicObjectiveCardConfig(Image& image, puoc_etype _type, size_t defaultValue)
	    : type(_type), checkButton_Selected("Select"),
	      lne_SatisfactionValue("Satisfaction value", std::to_string(defaultValue))
	{
