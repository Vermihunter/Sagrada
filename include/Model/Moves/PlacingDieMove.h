...
struct PlacingDieMove : ToolCardMove {
	...
	{
		return new PlacingDieMove(playerId, ind,
	...
	{
		PlacingDieMove* otherPlacingDieMove = dynamic_cast<PlacingDieMove*>(otherMove);
		return (otherPlacingDieMove != nullptr ? bm.equals_to_dtfm(otherPlacingDieMove->bm)
		                                       : false);
	}
