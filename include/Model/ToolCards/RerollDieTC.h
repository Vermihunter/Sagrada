...
class RerollDieTC : public ToolCard
{
  public:
    ...
    {
        Move(ID_t _playerId, size_t _ind, Die* d, value_t _prevVal,
        ...
        {
            return new RerollDieTC::Move(playerId, ind,
        ...
        {
            RerollDieTC::Move* otherRerollingMove =
                dynamic_cast<RerollDieTC::Move*>(otherMove);
            if (!otherRerollingMove) {
                return false;
            }

            return *die == *otherRerollingMove->die &&
                   prevVal == otherRerollingMove->prevVal &&
