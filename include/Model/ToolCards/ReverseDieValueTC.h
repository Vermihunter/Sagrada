...
class ReverseDieValueTC : public ToolCard {
  public:
	...
	virtual tc_t clone() override { return std::make_unique<ReverseDieValueTC>(*this); }
  ...
  private:
	...
	void append_value_reverser_moves(move_c& moveContainer, ID_t playerId, Game& g,
	                                 ID_t toolCardInd);

	void append_die_placing_moves(move_c& moveContainer, tool_card_move_t& prevMove);
