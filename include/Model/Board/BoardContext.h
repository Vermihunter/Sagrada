...
struct BoardContext {
	...
	BoardContext(BoardContext& other, DiceSupply& newDiceSupply, DiceSupply& originalDiceSupply);
	 ...
	 * @return board_ctx_t
	 */
	board_ctx_t clone(DiceSupply& newDiceSupply, DiceSupply& originalDiceSupply);
