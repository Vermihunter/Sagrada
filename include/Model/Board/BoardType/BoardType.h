...
class BoardType
{
  public:
    ...
    BoardTypeNeighborProcessor* get_neighbor_processor() const
    {
    ...
    virtual std::unique_ptr<BoardDataInputHandler> construct_input_handler(
        board_data_t& _boardData, board_config_t _config) = 0;
  ...
  protected:
    ...
    BoardType(const std::string& operatorName, BoardType* concreteOperator,
        ...
        : neighborProcessor(_neighborProcessor)
        , placeabilityProcessor(_placeabilityProcessor)
    {
