...
{
    static size_t get_abs_col_ind(size_t i, size_t relColInd)
    {
        return (relColInd * col_size) + i;
    }

    static size_t get_abs_val_ind(size_t i, size_t relValInd)
    {
        return (i * col_size) + relValInd;
    }
};
...
struct GeneralPlaceableDice
{
    ...
    {
        return any_having_attribute(color, color_size,
                                    &AbsoluteIndexMapper::get_abs_col_ind);
    }

    bool any_having_value(value_t value)
    {
        return any_having_attribute(value, val_size,
                                    &AbsoluteIndexMapper::get_abs_val_ind);
    }
    ...
    void allow_color(color_t color)
    {
        throw std::invalid_argument {"Not implemented"};
    }

    void allow_value(value_t value)
    {
        throw std::invalid_argument {"Not implemented"};
    }
    ...
    {
        disallow_attribute(value, val_size,
                           &AbsoluteIndexMapper::get_abs_val_ind);
    }

    void disallow_color(color_t color)
    {
        disallow_attribute(color, col_size,
                           &AbsoluteIndexMapper::get_abs_col_ind);
    }
    ...
    template <typename Attribute>
    void disallow_attribute(Attribute attr, const attrSize,
                            size_t (*indMapper)(size_t, size_t))
    {
        size_t relAttrInd = size_t(attr);
