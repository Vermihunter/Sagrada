...
class Game {
  public:
	enum single_move_choice_strategy_t { SINGLE_MOVE_STRATEGY_FIRST, SINGLE_MOVE_STRATEGY_RANDOM };
	 ...
	 */
	game_t clone() const { return std::make_unique<Game>(*this, ctx->rnd->clone()); }
	...
	{
		return std::make_unique<Game>(*this, RandomGenerator::initialize_with_seed(seed));
	}
	 ...
	 * This functionality is currently not implemented and not used
	 */
	void undo_dtfm(die_to_field_move_t m, bool putDieBackToCurrRoundsDice, bool shiftRoundsBack);
